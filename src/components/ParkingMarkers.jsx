...
function ParkingMarkers() {
  ...
  const fetchInfo = async () => {
    try {
      const res = await apiHelper.get(`${process.env.PUBLIC_URL}/data/info.json`) //axios automatically create json, emit res.json() & process res code
  ...
  const fetchAvailability = async () => {
    try {
      const res = await apiHelper.get('https://tcgbusfs.blob.core.windows.net/blobtcmsv/TCMSV_allavailable.json')
